...
## Novidade da v1.2.0: PDF local via mensagem direta
...
diretamente para a aba do viewer via `chrome.tabs.sendMessage()`. O viewer decodifica
...
- **v1.2.0**: PDF local via mensagem direta (sem storage), sem limite de tamanho.
...
5. Confirme que a versao mostrada e 1.2.0.
